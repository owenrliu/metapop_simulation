...
sim.dipop <- function(nyears=200,max.age=14,Linf=52.2,K=0.354,t0 = -0.766, surv=0.863, mort=1-0.863, repr.age=2, gamma=0.125,fert1=0.0129,fish=1-0.863,fert2=3.03,a.mu=0.0016,a.cv=0.5, ext.mean=1000, ext.cv=0.5) {
  ## age vector
  age.vec <- 0:max.age
