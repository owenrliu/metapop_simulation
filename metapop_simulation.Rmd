...
B.vec.test <- seq(0.001,0.01,by=.0001)
S.test <- sapply(n.vec.test, S.dd, a=a,f.vec=f.vec,ext=ext)
G.test <- sapply(n.vec.test,G,B=0.001,a=a,f.vec=f.vec,ext=ext,gamma=gamma)
plot(n.vec.test,G.test, type='l')
```
